...
class DrakeGymEnv(gym.Env):
    ...
    def __init__(self,
                 ...
                 hardware: bool = False,
                 set_info: Callable[[dict, Simulator, Context], None] = None,
                 set_options: Callable[[dict], None] = None,
                 ):
        """
        Args:
            simulator: Either:
        ...
        if set_info is None or callable(set_info):
            self.set_info = set_info
        else:            
            raise ValueError("Invalid set_info argument")
        
        if set_options is None or callable(set_options):
            self.set_options = set_options
        else:            
            raise ValueError("Invalid set_options argument")
    ...
    def step(self, action):
        ...
        if self.set_info is not None:
            self.set_info(info, self.simulator, context)
    ...
    def reset(self, *,
        ...
        if self.set_options is not None and options is not None:
